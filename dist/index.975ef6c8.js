...
countryInput.addEventListener("input", (0, _lodashDebounceDefault.default)(onCountryInput, DEBOUNCE_DELAY));
function onCountryInput() {
    const name = countryInput.value.trim();
    if (name === "") return countryList.innerHTML = "", countryInfo.innerHTML = "";
    (0, _fetchCountries.fetchCountries)(name).then((countries)=>{
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix":"5WWYd","./js/fetch-countries":"3Hsrc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"3Hsrc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function fetchCountries(name) {
    return fetch(`${BASE_URL}${name}?${fields}`).then((response)=>response.json()).catch((error)=>console.log(error));
}
